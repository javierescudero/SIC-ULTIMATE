			...
			<fieldset data-role="controlgroup">
				<?php
					...
					if ($accesElectronica === false) {
						...
						<a href="../../../sic-ultimate/modulos/capturistaD/index.php?area=Electronica&areasPerm=<?php echo "$areasPerm"; ?>&user=<?php echo "$user"; ?>" id="btnElectronica" class="ui-btn ui-icon-gear ui-btn-icon-left" data-ajax="false">Electronica</a>
					<?php
					}
				?>
				...
				<?php
					...
					if ($accesElectromecanicos === false) {
						...
						<a href="../../../sic-ultimate/modulos/capturistaD/index.php?area=Electromecanicos&areasPerm=<?php echo "$areasPerm"; ?>&user=<?php echo "$user"; ?>" id="btnElectromecanicos" class="ui-btn ui-icon-gear ui-btn-icon-left" data-ajax="false">Electromecanica</a>
					<?php
					}
				?>
				...
				<?php
					...
					if ($accesValvulas === false) {
						...
						<a href="../../../sic-ultimate/modulos/capturistaD/index.php?area=Valvulas&areasPerm=<?php echo "$areasPerm"; ?>&user=<?php echo "$user"; ?>" id="btnValvulas" class="ui-btn ui-icon-gear ui-btn-icon-left" data-ajax="false">Valvulas</a>
					<?php
					}
				?>
			</fieldset>
